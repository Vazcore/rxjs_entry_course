...
var average$ = Rx.Observable.interval(2000)
.map(() => {
...
average$.flatMap(statistic => {
  return Rx.DOM.get('/speed?avg=' + statistic.current)
...
var subscribtionForPromise = Rx.Observable.fromPromise(p)
// .subscribe(() => {
//   console.log('Promise was resolved!!!');
// });


// subscribtionForPromise.dispose();
